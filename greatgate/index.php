...
<head>
    ...
    <meta name="mailru-domain" content="1Rqg5lhYwIKtjdYA" />
</head>
...
?>
    ...
    <div class="popup-container">
        <div class="popup">
            <form method="POST" class="form-header" action="send_mail.php">
                <ul class="choose-list" style="display: none;">
                    <li>
                        <input type="hidden" class="input-text-width" style="background-color: transparent; border: 0px solid white; font-size: 18px; width: 41px;" name="ширина">
                        <input type="hidden" class="input-text-height" style="background-color: transparent; border: 0px solid white; font-size: 18px; width: 41px;" name="высота">
                    </li>
                    <li>
                        <!-- <textarea rows="3" class="input-text-type" style="background-color: transparent; border: 0px solid white; font-size: 15px;width: 182px; resize: none;" name="полотно"></textarea> -->
                        <input type="hidden" class="input-text-type" style="background-color: transparent; border: 0px solid white; font-size: 15px;width: 182px; text-align: right;" name="полотно">

                    </li>
                    <li>
                        <input type="hidden" class="input-text-gate-small" style="background-color: transparent; border: 0px solid white; font-size: 18px;width: 29px;" name="калитка">
                    </li>
                    <li>
                        <input type="hidden" class="input-text-automatic" style="background-color: transparent; border: 0px solid white; font-size: 18px; width: 59px; text-align: right;" name="автоматизация">
                    </li>
                    <li>
                    </li>
                </ul>
                <ul class="calc-pars">
                    <input type="hidden" class="input-text-check" style="background-color: transparent; border: 0px solid white; font-size: 15px; margin-left: 80px" name="работы-1">
                    <input type="hidden" class="input-text-check-2" style="background-color: transparent; border: 0px solid white; font-size: 15px; margin-left: 80px" name="работы-2">
                    <input type="hidden" class="input-text-check" style="background-color: transparent; border: 0px solid white; font-size: 15px; margin-left: 80px" name="работы-3">
                </ul>
                <input class="choose-config-input" type="hidden" placeholder="00 000" value="<?php if ($sum != 0) $sum; ?>">
    ...
    <div class="white-bar">
        <div class="fixed-container clearfix">
            ...
            <div class="white-bar-phone-link">
                <a href="tel:74959993834"><span class="phone-link-blue">+7 495</span> 999-38-34</a>
            </div>
    ...
    <div class="nav-bar">
        ...
        <!-- <div class="nav-bar">
            ...
            <div class="form-block">
              ...
              <form action="send_mail.php" method="POST" class="form-header">
                  <ul class="choose-list" style="display: none;">
                      <li>
                          <input type="hidden" class="input-text-width" style="background-color: transparent; border: 0px solid white; font-size: 18px; width: 41px;" name="ширина">
                          <input type="hidden" class="input-text-height" style="background-color: transparent; border: 0px solid white; font-size: 18px; width: 41px;" name="высота">
                                ...
                                <ul class="choose-list">
                                        <li>
                                            ...
                                            <span class="input-width-height-span">
                                                ...
                                                <span class="mm-width-height" style="display: none;">мм</span>
                                            </span>
                                        ...
                                        <li>
                                            <b>Полотно ворот:</b>
                                            <span class="input-width-height-span">
                                                 <textarea rows="2" class="input-text-type" name="полотно"></textarea>
<!--                                                <input type="textarea" class="input-text-type" style="background-color: transparent; border: 0px solid white; font-size: 15px;width: 182px; text-align: right;" name="полотно">-->
                                            </span>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <span class="input-width-height-span">
                                                <input type="text" class="input-text-automatic" style="background-color: transparent; border: 0px solid white; font-size: 18px; width: 59px; text-align: right;" name="автоматизация">
                                            </span>
                                        </li>
                                        <li>
                                ...
                                <ul class="calc-pars">
                                    <input type="text" class="input-text-check" name="работы-1"><br>
                                    <input type="text" class="input-text-check-2" name="работы-2"><br>
                                    <input type="text" class="input-text-check" name="работы-3">
                                </ul>
...
<!--                            <p class="calc-par">Бетонирование отдельно стоящих столбов</p>-->
                        ...
                        <form class="choose-config-form">
                            <input class="choose-config-input" type="text" placeholder="00 000" value="<?php if ($sum != 0) $sum; ?>">
                            <label class="choose-config-ruble">руб.</label>
                        </form>
                    </div>
                        ...
                        <form method="POST" class="tabs-pane-four" action="/controller.php" class="form-automatic">
                            <div class="automatic-block-main">
                                <div class="automatic-block">
                                    <label class="label">
                                        <input type="radio" class="radio" name="pane-radio-4" value="Автоматическое" id="autocheck">
                                        <span class="fake"></span>
                            ...
                            <div class="tabs-pane-four-self">
                                <label class="label">
                                    <input type="radio" class="radio" name="pane-radio-4" value="Ручное" id="ruch">
                                    <span class="fake"></span>
        ...
        <div class="fixed-container clearfix meas-con">
            ...
            <div class="measure-list-block">
                <ul class="measure-list">
                    <li>Выезд специалиста на объект<br> в любое удобное для заказчика<br> время</li>
            ...
            <div id="map" style="width: 100%; height: 658px">
                <div class="geo-measure-block">
                    <div class="fixed-container">
                        ...
                        <form method="POST" class="form-footer" action="send_mail.php">
                            <ul class="choose-list" style="display: none;">
                                <li>
                                    <input type="hidden" class="input-text-width" style="background-color: transparent; border: 0px solid white; font-size: 18px; width: 41px;" name="ширина">
                                    <input type="hidden" class="input-text-height" style="background-color: transparent; border: 0px solid white; font-size: 18px; width: 41px;" name="высота">
